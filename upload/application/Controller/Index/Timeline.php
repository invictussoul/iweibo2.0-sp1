 ...
 * @version $Id: Controller_Index_Timeline.php 2011-06-07 11:50:00Z gionouyang $
 * @package Controller
 * @since 2.0
 */
class Controller_Index_Timeline extends Core_Controller_TAction
{
    ...
    protected function getMore($type, $name = '')
    {
        ...
        $this->assign('hasfront', 1);
        
        $data = $this->fetch('common/teach.tpl');
        $data or $data = null;
