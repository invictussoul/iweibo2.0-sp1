...
<html>
    <head>
    <title><!--{$guest.nick}-->收听的人 - <!--{TO->cfg key="site_name" group="basic" default="iWeibo2.0"}--></title>
...
<div class="wrapper content">
    <div class="fleft contentleft">
        ...
        <div class="tabbar">
        <ul class="tabs">
        <li class="tab active"><strong><!--{if $guest.sex==2}-->她<!--{else}-->他<!--{/if}-->收听的人</strong></li>
        <li class="tab"><a href="/friend/follower/uname/<!--{$guest.name}-->"><!--{if $guest.sex==2}-->她<!--{else}-->他<!--{/if}-->的听众</a></li>
        </ul>
        <div class="fright">
        收听<!--{$unum}-->人
        </div>
