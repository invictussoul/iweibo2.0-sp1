...
<div class="toggle" title='<!--{$component.title|escape:"html"}-->'><!--{$component.title|escape:"html"|itruncate:33}--></div>
    <ul class="userlist2">
        ...
        <li <!--{if $smarty.foreach.thisloop.last}-->class="last"<!--{/if}-->>
            <div class="fleft">
                <a href="/u/<!--{$item.name|iurlencode}-->" title='<!--{$item.nick|escape:"html"}-->(@<!--{$item.name|escape:"html"}-->)'>
                <img title='<!--{$item.nick|escape:"html"}-->(@<!--{$item.name|escape:"html"}-->)' width="50" height="50" src="<!--{if $item.head}--><!--{$item.head}-->/50<!--{else}-->http://mat1.gtimg.com/www/mb/images/head_50.jpg<!--{/if}-->" /></a>
            ...
            <div class="fright">
            <h6><a href="/u/<!--{$item.name|iurlencode}-->" title='<!--{$item.nick|escape:"html"}-->(@<!--{$item.name|escape:"html"}-->)'><!--{$item.nick|escape:"html"}--></a></h6><p><!--{$item.description|itruncate:50:"..."}--></p></div>
        </li>
        <!--{/foreach}-->
    </ul>
