...
<div class="floattop">
    <div class="itemtitle">
        <h3>数据调用</h3>
        <ul class="tab1">
            <li class="current"><a href="javascript:void(0);"><span>推荐用户</span></a></li>
...
<table class="tb tb2">
    <tr>
        ...
        <td width="200"><input type="text" class="txt" id="title" name="title" value="推荐用户" datatype="Require" msg="请填写头部文字" /></td>
        <td><span info="title"></span></td>
    </tr>
    <tr>
        <td>指定用户类型</td>
        <td>
            <input type="radio" id="recommend" name="recommendtype" value="1" checked /> 推荐用户
            <input type="radio" id="localauth" name="recommendtype" value="2" /> 认证名人
        </td>
        <td></td>
    </tr>
    <tr>
