...
<form id="addform" name="addform" method="post" action="/admin/plugin/install">
...
<table class="tb tb2">
    ...
    <tr class="noborder">
        <td class="vtop rowform"><input type="text" class="txt" id="foldername" name="foldername" value="<!--{$conditions.foldername}-->" readonly /></td>
    ...
    <tr><td colspan="2"><input type="submit" class="btn" id="addsubmit" name="addsubmit" value="提交"></td></tr>
</table>
</form>
