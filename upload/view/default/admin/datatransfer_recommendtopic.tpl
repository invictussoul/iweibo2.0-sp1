...
<div class="floattop">
    <div class="itemtitle">
        ...
        <ul class="tab1">
            ...
            <li class="current"><a href="javascript:void(0);"><span>推荐话题</span></a></li>
...
<table class="tb tb2">
    <tr>
        ...
        <td width="200"><input type="text" class="txt" id="title" name="title" value="推荐话题" datatype="Require" msg="请填写头部文字" /></td>
        <td><span info="title"></span></td>
    </tr>
    <tr>
        <td>指定话题</td>
        <td><input type="text" class="txt" id="name" name="name" value="" datatype="Require" msg="请填写指定话题" /></td>
