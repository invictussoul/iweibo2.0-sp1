...
<form name="cpform" method="post" action="/admin/tlive/pass" id="cpform" >
<table class="tb tb2 ">
...
<!--{if $tls.size > 0 }-->
    ...
    <tr class="hover">
        ...
        <td><A href="/tlive/view/id/<!--{$tpost.tid}-->" target="_blank" title="<!--{$tpost.tname}-->"><!--{$tpost.tname|itruncate:20:"..."}--></a></td>
        <td><!--{$tpost.text}--></td>
        <td><!--{$tpost.name}--></td>
        ...
        <td>
            ...
            <a href="/admin/tlive/pass/t/0/id/<!--{$tpost.msgid}-->">屏蔽</a>
            <!--{else}-->
            <span style="color:Red">已屏蔽</span>
            <a href="/admin/tlive/pass/t/1/id/<!--{$tpost.msgid}-->">通过</a>
            <!--{/if}-->
        </td>
        <td></td>
    </tr>
