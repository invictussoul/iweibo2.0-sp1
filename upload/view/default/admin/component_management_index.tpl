...
-->
    ...
    <table class="tb tb2 ">
        ...
        <tr class="hover">
            <td align="align"><input class="checkbox" type="checkbox" name="configs[<!--{$componentType}-->][status]"<!--{if '1' === $component.component_status}--> checked="checked"<!--{/if}-->></td>
            ...
            <td align="align"><a href="/admin/componentmgt/edit/whichpage/<!--{$whichpage}-->/component/<!--{$componentType}-->/main">编辑</a></td>
            <td></td>
        </tr>
        <!--{/foreach}-->
        <tr>
