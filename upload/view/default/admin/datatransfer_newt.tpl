...
<div class="floattop">
    <div class="itemtitle">
        ...
        <ul class="tab1">
            ...
            <li><a href="/admin/datatransfer/pendant"><span>微博广播站</span></a></li>
            <li class="current"><a href="javascript:void(0);"><span>最新微博</span></a></li>
        </ul>
    </div>
</div>
...
<table class="tb tb2">
    <tr>
        ...
        <td width="200"><input type="text" id="title" name="title" value="最新微博" datatype="Require" msg="请填写头部文字" /></td>
        <td><span info="title"></span></td>
    </tr>
    <tr>
        <td>指定多个微博帐号<br>用半角逗号分隔</td>
        <td><input type="text" maxlength="100" id="name" name="name" value="" datatype="Require" msg="请填写指定用户" /></td>
        <td><span info="name">提示：此处填写的微博帐号必须是绑定了本地帐号的腾讯微博帐号</span></td>
    </tr>
    <tr>
        <td>数据条数</td>
        <td>
    ...
    <tr>
        <td>宽度</td>
        <td><input type="text" maxlength="4" id="width" name="width" value="300" datatype="Number" msg="请正确填写宽度" /></td>
        <td><span info="width"></span></td>
    </tr>
    <tr>
        <td>高度</td>
        <td><input type="text" maxlength="4" id="height" name="height" value="500" datatype="Number" msg="请正确填写高度" /></td>
