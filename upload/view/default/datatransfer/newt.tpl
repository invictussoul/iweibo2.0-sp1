...
<html>
    <head>
        ...
        <style type="text/css">
            body{margin:0;padding:0;background:<!--{$css.bgcolor}-->;color:<!--{$css.fontcolor}-->; font:12px Verdana, Lucida, Helvetica, Arial, "宋体",  sans-serif;}
            h1, h2, h3, h4, h5, h6, form,ul,p,li{margin:0; padding:0;list-style:normal;}
            a{text-decoration:none;}
            a img{border:0;}
            .clear{clear:both;}
            .btn_green{background:url(about:blank)\9;}
            .iweibo{height:<!--{$css.height-2}-->px;border:1px solid <!--{$css.bordercolor}-->;float:left;margin-left:0px;width:<!--{$css.width-2}-->px;}
            ...
            background:-webkit-gradient(linear, left top, left bottom, from(#BFEBFB), to(#9CDEF4));filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#BFEBFB', endColorstr='#9CDEF4');border:1px solid <!--{$css.bordercolor}-->;border-width:1px 0;font-size:24px;text-shadow:1px 1px 1px #5FC7EA;overflow:hidden;}
            .iweibo h2 a{display:block;line-height:100%;color:#fff;}
            ...
            .iweibo .profile{margin-left:10px;width:220px;_width:200px;position:relative;}
            ...
            .iweibo_client .tcontainer{height:413px;}
            .iweibo_more .tcontainer{height:<!--{$css.height-69}-->px;}
