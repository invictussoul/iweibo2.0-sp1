...
window.isInstantTimelineByMsgContent = function (data) {
    var content = $(data).text().replace(/\s+/g,'');
    var topicText = $("#msgTxt").attr("data-default");
    return content.indexOf(topicText) >= 0;
};
